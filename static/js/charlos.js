...
// Using require() syntax as bable will shift all imports up
// we need $/jQuery in the global scope before dropotron requires it, original syntax:
// import $ from 'jquery';
...
// let isInViewport = require('isInViewport');
...
$(function () {
  ...
  console.log('dropotron: ' + (typeof $.dropotron === "function"));
  console.log('skel: ' + skel);

  // a library for instantiated p5 sketches
  // window.p5sketches = {};
  // check if the sketches are in view
  // $(window).on('scroll', _.debounce(function() {
  //   if (_.size(p5sketches) === 0)
  //     return;
  //
  //   _.each(p5sketches, (s) => {
  //     if (isInViewport.isInView([s.canvas])) { // plugin requires an array : https://github.com/Josh-Miller/isInViewport/blob/master/isInViewport.js
  //       s.loop();
  //     }
  //     else {
  //       s.noLoop();
...
},{"../_modules/link/link":5,"dropotron":1,"jquery":2,"skel-framework":3,"telephasic":7,"underscore":4,"util":8}],7:[function(require,module,exports){
(function (global){

; $ = global.$ = require("jquery");
skel = global.skel = require("skel-framework");
; var __browserify_shim_require__=require;(function browserifyShim(module, define, require) {
'use strict';
...
(function ($) {
	...
	$(function () {
		...
		// Navigation Panel.
		$('<div id="navPanel">' + '<nav>' + '<a href="index.html" class="link depth-0">Home</a>' + $('#nav').navList() + '</nav>' + '</div>').appendTo($body).panel({
			delay: 500,
			hideOnClick: true,
			resetScroll: true,
			resetForms: true,
...
},{"jquery":2,"skel-framework":3}],8:[function(require,module,exports){
(function (global){
